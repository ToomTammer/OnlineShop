...
namespace Shopping.Controllers
{
    public class TbProductsController : Controller
    {
        ...
        public TbProductsController(ShoppingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var tbProduct = await _context.TbProduct
                .Include(t => t.Cate)
        ...
        public IActionResult Create()
        {
            ...
            if (TempData["UserName"] != null)
            {
                ViewData["CateId"] = new SelectList(_context.TbCategory, "CateId", "CateName");
                TempData.Keep();
                return View();
            }
            else
        ...
        public async Task<IActionResult> Create([Bind("PdId,PdImg,PdName,PdPrice,PdStock,PdStatus,CateId,PdDetail,PdSubHead,PdDelete")] TbProduct tbProduct, List<IFormFile> PdImg)
        {
            ...
            ViewData["CateId"] = new SelectList(_context.TbCategory, "CateId", "CateName", tbProduct.CateId);
            TempData.Keep();
            return View(tbProduct);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            if (TempData["UserName"] != null)
            {
                ...
                var tbProduct = await _context.TbProduct.FindAsync(id);
                if (tbProduct == null)
                {
                    return NotFound();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            TempData.Keep();
            var tbProduct = await _context.TbProduct.FindAsync(id);
            _context.TbProduct.Remove(tbProduct);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.TbProduct.Any(e => e.PdId == id);
        }
        ...
        {
            {
                ...
                {
                    TempData.Keep();
                    return View("Index", _context.TbProduct.ToList());

                }
                else
                {
                    TempData.Keep();
                    return View("Index", _context.TbProduct.Where(p => p.PdName.Contains(query)).ToList());
                }
            }
        }
    }
