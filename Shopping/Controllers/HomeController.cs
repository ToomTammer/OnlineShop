    ...
    public class HomeController : Controller
    {
       ...
       //     _logger = logger;
        ...
        public async Task<IActionResult> IndexAsync()
        {
            ...
            ViewData["PdName"] = new SelectList(_context.TbProduct, "PdId", "PdName");
        ...
        {
            TbProduct p = _context.TbProduct.Where(x => x.PdId == Id).SingleOrDefault();
            ...
            //{
                {
                    ...
                    {
                        TempData.Keep();
                        return View("ProductCategory",_context.TbProduct.ToList());

                    }
                    else
                    {
                        TempData.Keep();
                        return View("ProductCategory", _context.TbProduct.Where(p => p.PdName.Contains(querry)).ToList());
                    }
                }
            //}
